...
import com.aplus.edu.api.response.ExmPdfDataItem
...
class ExampdfAdapter internal constructor(
    private val context: Context,
    private val mData: List<ExmPdfDataItem>,
    val listner: Exampdfcommunicator
) : RecyclerView.Adapter<ExampdfAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = mInflater.inflate(R.layout.exampdf_row, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.pdf_name_tv.text = data.pdf
    ...
    interface Exampdfcommunicator {
        fun onRowClick(data: ExmPdfDataItem)
    }
}